...
function AddTodo({ addTask }: any) {
  ...
  return (
    <div className="max-w-[700px] mt-16">
      <h3 className="text-xl font-bold text-gray-400 flex md:hidden text-center mb-4">
        Add new task
      </h3>
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="bg-teal-500  dark:bg-[#FF6500] dark:hover:bg-[#FF6500]/80 px-4 py-2 rounded-md h-12 text-white text-lg md:text-xl font-semibold hover:bg-teal-600 duration-200 transition-all"
        >
          Add now
        </button>
      </form>
